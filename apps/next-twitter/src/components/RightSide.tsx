    ...
    return (
        ...
        <div className="w-2/5 h-12">
          ...
          <div className="relative text-gray-300 w-80 p-5 pb-0 mr-16">
            ...
            <input type="search" name="search" placeholder="Search Twitter" className="bg-black border-white border h-10 px-10 pr-5 w-full rounded-full text-sm focus:outline-none bg-purple-white shadow">
            </input>

          </div>

          <div className="max-w-sm rounded-xl bg-custom-gray overflow-hidden shadow-lg m-4 mr-20">
            <div className="flex">
          ...
          <div className="max-w-sm rounded-lg  bg-custom-gray overflow-hidden shadow-lg m-4 mr-20">
            <div className="flex">
              <div className="flex-1 m-2">
