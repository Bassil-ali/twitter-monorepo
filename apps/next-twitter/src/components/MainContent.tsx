...
export default function MainContent({children}:Props) {
    return (
        <div className="w-3/5  h-screen border border-gray-600 border-t-0">
            ...
            {/*         {/1* <img className="rounded-lg w-full h-64" src="https://images.unsplash.com/photo-1556740738-b6a63e27c4df?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=448&q=80" alt="Woman paying for a purchase"> *1/} */}
            {/*     </div> */}
            {/*     <div className="flex"> */}
